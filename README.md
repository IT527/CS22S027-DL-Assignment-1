...
To clone the repository directly to you local machine, ensure git is installed, run the command: `git clone https://github.com/IT527/CS22S027-DL-Assignment-1.git`
